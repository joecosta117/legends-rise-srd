      ...
      <div className='archetypes-content'>
        ...
        {selectedArchetype === "Archangel" && (
          <div>
            ...
            <p>You radiate sacred power that protects all. You and allies within your zone gain <Modifier type="f" count="2" /> to overcome rolls.</p>
        ...
        {selectedArchetype === "Demigod" && (
          <div>
            ...
            <p>You can manifest divine miracles. You learn the wish ritual spell. You can cast wish with <Modifier type="f" count="1" />, without spending the material cost, and you add your proficiency bonus to the ritual’s skill roll even if you don’t know magic.</p>
        ...
        {selectedArchetype === "Demon Lord" && (
          <div>
            ...
            <p>You learn the summon fiend battle spell even if you don't know the unholy tradition. Once per short, you can cast this spell at a spell tier equal to your tier without spending mana.</p>
        ...
        {selectedArchetype === "Dragon Ascendant" && (
          <div>
            ...
            <p>You learn the dragon transformation battle spell even if you don’t know the arcane magic tradition. Once per short rest, you can cast this spell at a spell tier equal to your tier without spending mana.</p>
        
            <h4 className="header">Greater Dragon Form (10th-Level Feature)</h4>
            <p>When you cast the dragon transformation battle spell, and the spell’s benefits improve in the following ways:</p>
            <ul>
        ...
        {selectedArchetype === "Emergent Primordial" && (
          <div>
            ...
            <h4 className="header">Unleash Primordial Fury (8th-Level Feature)</h4>
            <p>You gain the following ability:</p>
            <AbilityCard
            ...
            <h4 className="header">Birth of Elemental Titan (10th-Level Feature)</h4>
        ...
        {selectedArchetype === "Eternal Trickster" && (
          <div>
            ...
            />
            <h4 className="header">Supernatural Slippery (10th-Level Feature)</h4>
        ...
        {selectedArchetype === "Infinite Wanderer" && (
          <div>
            ...
            <p>You learn the teleport ritual spell. You can cast teleport with <Modifier type="f" count="1" />, and you add your proficiency bonus to the ritual’s skill roll even if you don’t know magic.</p>
            ...
            <h4 className="header">Otherworldly Wanderer (10th-Level Feature)</h4>
            <p>You learn the realm shift ritual spell. You can cast realm shift with <Modifier type="f" count="1" />, and you add your proficiency bonus to the ritual’s skill roll even if you don’t know magic.</p>
        ...
        {selectedArchetype === "Legendary Hero" && (
          <div>
            ...
            <h4 className="header">Incredible Achievements (10th-Level Feature)</h4>
        ...
        {selectedArchetype === "Legendary Sovereign" && (
          <div>
            ...
            <p>Once per long rest, when you are vanquished, you instead Stand and heal equal to your shaken value. At the end of your adventures, you fully ascend to your throne and begin a long and prosperous rule over your domain. Your renown guarantees prosperity for your people for decades to come. Your descendants will one day earn your throne and cement  your legacy as one of the greatest sovereigns in history.</p>
          </div>
        )}
        ...
        {selectedArchetype === "Nameless One" && (
          <div>
            ...
            <p>You learn the twist reality battle spell, even if you don’t know the eldritch magic tradition. You can cast the spell without spending mana.</p>
        ...
        {selectedArchetype === "Primal Aspect" && (
          <div>
            ...
            <h4 className="header">One with the Elements (8th-Level Feature)</h4>

    ...
    <div className="summoner">
      <div className="summoner-content">
        ...
        <div className="tab-items">
          <div onClick={toggleDetails} className="tab-items__tab" data-selected={isDetails}>Summoner Details</div>
          <div className="tab-items__divider">|</div>
          <div onClick={toggleSubclasses} className="tab-items__tab" data-selected={isSubclasses}>Summoner Subclasses</div>
          <div className="tab-items__divider">|</div>
          <div onClick={toggleTalents} className="tab-items__tab" data-selected={isTalents}>Summoner Talents</div>
        </div>
        {isDetails && (
          <div>
            <h1>Summoner</h1>
            ...
            <h3 className="header" style={{marginTop: '25px'}}>Summon's Adaptation</h3>
        ...
        {isSubclasses && (
            ...
            <ul>
              ...
              <li><span><b>Summons:</b> Your minor and major summons gains the following modifications:</span>
                <ul style={{marginLeft: '10px', marginTop: '0'}}>
                  ...
                  <li><span><i>Fire:</i> Resistance to fire damage equal to your proficiency bonus, weakness to cold damage equal to your proficiency bonus, and their assault damage deals fire damage. On a critical successful assault from the major summons, the target takes ongoing fire damage equal to your tier.</span></li>
                  <li><span><i>Ice:</i> Resistance to cold damage equal to your proficiency bonus, and their assault damage deals cold damage. On a critical successful assault from the major summons, the target is seized (turn ends).</span></li>
          ...
          <h2>Constructs</h2>
            <p>You conjure mechanical entities from the realm of law to impose order upon your enemies.</p>
            <h3 className="header">Mechanical Alignment (1st-Level Feature)</h3>
            <p>You gain the following features:</p>
            <ul>
              <li><span><b>Magic Tradition:</b> For this class’s magic tradition, choose to learn arcane, enchantment, or protection.</span></li>
              <li><span><b>Theme:</b> Arcane</span></li>
              <li><span><b>Summons:</b> Your minor and major summons gains the following modifications:</span>
                <ul style={{marginLeft: '10px', marginTop: '0'}}>
                  <li><span>Resistance to arcane and physical damage equal to your tier</span></li>
            ...
            <ul>
              ...
              <li><span><b>Summons:</b> Your minor and major summons gains the following modifications:</span>
                <ul style={{marginLeft: '10px', marginTop: '0'}}>
                  <li><span>Resistance to unholy damage equal to your tier</span></li>
            ...
            <ul>
              ...
              <li><span><b>Summons:</b> Your minor and major summons gains the following modifications:</span>
                <ul style={{marginLeft: '10px', marginTop: '0'}}>
                  <li><span>Resistance to necrotic damage equal to your tier</span></li>
        ...
        {isTalents && (
          <div>
            ...
            <p>When a creature dies within your major summons’ zone, your summons regains hit points equal to your tier. It can only heal in this way once per turn.</p>

            <h3 className="header">Damning Summons</h3>
            <p style={{marginBottom: 0}}><b>Requirement:</b> fiends subclass</p>
            <p>When you use conjure summons, choose a number of enemies equal to your proficiency bonus within your major summons’ zone. Chosen enemies take 1 unholy damage per your tier.</p>
            ...
            <p>When you use conjure summons, you and all allies gain 1 temporary hit points per your tier (scene ends). </p>

            <h3 className="header">Sentinel's Sacrifice</h3>
            <p style={{marginBottom: 0}}><b>Requirement:</b> constructs subclass</p>
            <p>You gain the following features:</p>
            <AbilityCard
            ...
            <p>You can choose your major summons’ size to become large, or huge starting at 8th level. While large, your summons can use assault with <Modifier type="mf" count="1" /> to target any creature within their zone. </p>
            ...
            <p style={{marginBottom: 0}}><b>Requirement:</b> constructs subclass</p>
            <p>When your major summons is reduced to 0 hit points, you can spend mana equal to your tier for the major summons to heal equal to its shaken value.</p>

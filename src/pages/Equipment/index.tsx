    ...
    <div className="equipment">
      <div className="equipment-content">
        <div className="equipment-content__tabs">
          ...
          <div className="equipment-content__tabs__tab" onClick={handleWeapons}><p>Weapons</p></div>
          <div className="equipment-content__tabs__divider">|</div>
          <div className="equipment-content__tabs__tab" onClick={handleOtherGoods}><p>Other Goods</p></div>
          <div className="equipment-content__tabs__divider">|</div>
          <div className="equipment-content__tabs__tab" onClick={handleMounts}><p>Mounts</p></div>
        </div>
        ...
        {isArmor && (
          <div>
            <h2>Armor</h2>
            <p>Armor helps defend you from incoming physical harm. All armor unless magical or made out of special material is item tier 1 and costs 1 gold. All armor takes 1 minute to take on or off, except for shields. You can remove or wield a shield with the Interact maneuver.</p>
            <h3>Armor Training</h3>
            <p>Your class determines what armor you're trained in. If you aren’t trained in armor while wearing armor, then you are slowed and dazed.</p>
            <h3>Armor Types</h3>
            <p>There are three types of armor. Each armor grants certain benefits while worn.</p>
            <h4>Light Armor</h4>
            <p><i>The least restrictive of armor, light armor is typically made of leather or strategic placings of plate or chainmail to only protect vital areas.</i></p>
            <p>Light armor grants +2 to Evasion.</p>
            <h4>Heavy Armor</h4>
            <p><i>Heavy armor is sturdier than light armor, offering the best protection. Heavy armor is typically created from plates of metal, chainmail, or other dense material.</i></p>
            <p>Heavy armor grants +2 to Might and resistance to physical damage equal to your tier.</p>
            <h4>Shields</h4>
            <p><i>Shields are typically affixed to your arm to help protect you against incoming harm.</i></p>
            <p>Shields grant +1 to Evasion and can be used as a melee weapon, dealing 2 physical damage.</p>
          </div>
        )}
        {isWeapons && (
          <div>
            <h2>Weapons</h2>
            <p>Most adventurers have a weapon of some kind, even spellcasters, in case their spells fail them. All constructed weapons unless magical or made out of special material are item tier 1 and cost 1 gold. </p>
            <h3>Weapon Training</h3>
            <p>Your class determines what weapons you're trained in. If you aren’t trained in a weapon, then you don’t add your proficiency bonus to Strike with the weapon. Everyone is trained in natural melee weapons.</p>
            ...
            <ul>
              ...
              <li><span><b>Ranged:</b> Weapons useful at far ranges, and can target creatures within a number of zones. Creatures take <Modifier type="mf" count="1" /> to Strike an engaged target with a short or long ranged weapon.</span></li>
            </ul>
            
            <p>For each weapon type, please consult the weapon types table.</p>
            <ul>
              <li><span><b>Damage:</b> How much physical damage the weapon does.</span></li>
              <li><span><b>Range:</b> Melee weapons can only target engaged creatures. Ranged weapons list a range. For these weapons, you can make a Strike at a target within the listed range. If you Strike beyond this range, you take <Modifier type="mf" count="1" /> for each additional zone up to double the listed range.</span></li>
              <li><span><b>Hands:</b> How many hands you need to wield this weapon.</span></li>
              <li><span><b>Examples:</b> Weapon examples for that weapon type, but feel free to come up with your own!</span></li>
            </ul>
            <table>
              <thead>
                <tr>
        ...
        {isMounts && (
          <div>
            ...
            <ul>
              <li><span>Resistance to a damage type, with physical counting as two mount traits.</span></li>

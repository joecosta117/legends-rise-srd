    ...
    <div className="druid">
      <div className="druid-content">
        ...
        {isDetails && (
          <div>
            <h1>Druid</h1>
            <p>Druids commune with nature itself and channel ancient, primordial magic. Some Druids use this green gift to protect the natural world, while some use this magic to tear down civilization. Play a druid if you want to command nature magic while being attuned to the wilderness.</p>
            <h2>Druid Origins</h2>
            <p>Here are some suggestions for the origins of your magic:</p>
            <ul>
              <li><span><b>Devotion:</b> Through belief in a nature deity or primordial spirits, you’ve been rewarded with nature magic.</span></li>
              <li><span><b>Pact:</b> You made a pact with a powerful entity for your nature magic, such a fairy ruler or elemental royalty.</span></li>

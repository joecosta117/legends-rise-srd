      ...
      <div className='ancestries-content'>
        ...
        <div style={{paddingTop: "25px"}}>
          {selectedAncestry === "Human" && (
            <div>
              <h3 className="header" id="human">Human Ancestry</h3>
          ...
          {selectedAncestry === "Beastkin" && (
            <div>
              <h3 className="header" id="beastkin">Beastkin Ancestry</h3>
          ...
          {selectedAncestry === "Cambion" && (
            <div>
              <h3 className="header" id="cambion">Cambion Ancestry</h3>
          ...
          {selectedAncestry === "Dhampir" && (
            <div>
              <h3 className="header" id="dhampir">Dhampir Ancestry</h3>
          ...
          {selectedAncestry === "Drakkin" && (
            <div>
              <h3 className="header" id="drakkin">Drakkin Ancestry</h3>
          ...
          {selectedAncestry === "Dwarf" && (
            <div>
              <h3 className="header" id="dwarf">Dwarf Ancestry</h3>
          ...
          {selectedAncestry === "Elementalkin" && (
            <div>
              <h3 className="header" id="elementalkin">Elementalkin Ancestry</h3>
              ...
              <ul>
                ...
                <li><span><b>Elemental Magic (P):</b> You learn a battle spell depending on your elemental soul even if you don’t know the spell’s magic tradition: lightning bolts (air), stone armor (earth), fireball (fire), frozen prison (ice), or crashing wave (water). Once per short rest, you can cast this spell at a spell tier equal to your tier without spending mana.</span></li>
              </ul>
            </div>
          )}
          {selectedAncestry === "Elf" && (
            <div>
              <h3 className="header" id="elf">Elf Ancestry</h3>
          ...
          {selectedAncestry === "Forgeborn" && (
            <div>
              <h3 className="header" id="forgeborn">Forgeborn Ancestry</h3>
          ...
          {selectedAncestry === "Giantkin" && (
            <div>
              <h3 className="header" id="giantkin">Giantkin Ancestry</h3>
          ...
          {selectedAncestry === "Goblin" && (
            <div>
              <h3 className="header" id="goblin">Goblin Ancestry</h3>
          ...
          {selectedAncestry === "Gnome" && (
            <div>
              <h3 className="header" id="gnome">Gnome Ancestry</h3>
              ...
              <ul>
                ...
                <li><span><b>Faerie Lights (P):</b> You learn the dazzling lights battle spell. Once per short rest, you can cast this spell at a spell tier equal to your tier without spending mana.</span></li>
              </ul>
            </div>
          )}
          {selectedAncestry === "Halfling" && (
            <div>
              <h3 className="header" id="halfling">Halfling Ancestry</h3>
          ...
          {selectedAncestry === "Kobold" && (
            <div>
              <h3 className="header" id="kobold">Kobold Ancestry</h3>
          ...
          {selectedAncestry === "Lycanblood" && (
            <div>
              <h3 className="header" id="lycanblood">Lycanblood Ancestry</h3>
          ...
          {selectedAncestry === "Nephilim" && (
            <div>
              <h3 className="header" id="nephilim">Nephilim Ancestry</h3>
          ...
          {selectedAncestry === "Orc" && (
            <div>
              <h3 className="header" id="orc">Orc Ancestry</h3>
          ...
          {selectedAncestry === "Silvan" && (
            <div>
              <h3 className="header" id="silvan">Silvan Ancestry</h3>
          ...
          {selectedAncestry === "Umbraling" && (
            <div>
              <h3 className="header" id="umbraling">Umbraling Ancestry</h3>
              ...
              <ul>
                ...
                <li><span><b>Umbral Magic (P):</b> You learn the darkness battle spell even if you don’t know the shadow magic tradition. Once per short rest, you can cast this spell at a spell tier equal to your tier without spending mana.</span></li>
              </ul>
            </div>
          )}
          {selectedAncestry === "Wight" && (
            <div>
              <h3 className="header" id="wight">Wight Ancestry</h3>
          ...
          {selectedAncestry === "Mixed" && (
            <div>
              <h3 className="header" id="mixed">Mixed Ancestry</h3>

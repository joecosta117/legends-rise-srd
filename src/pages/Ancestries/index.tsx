  ...
  return (
    <div className='ancestries'>
      <div className='ancestries-content'>
        ...
        <p>You can choose from the following list of ancestries, including mixed ancestry (combination of two ancestries).</p>
        <ul className="ancestries-list">  
        <li><a href="#human"><b>Humans:</b></a><span>You are the most ambitious and adaptable of the mortals.</span></li>
          <li><a href="#beastkin"><b>Beastkin:</b></a><span>You are an animal-like humanoid attuned to nature.</span></li>
          <li><a href="#cambion"><b>Cambion:</b></a><span>You have been touched by the dark powers of the lower realms.</span></li>
          <li><a href="#dhampir"><b>Dhampir:</b></a><span>You have vampiric powers.</span></li>
          <li><a href="#drakkin"><b>Drakkin:</b></a><span>You are a draconic humanoid.</span></li>
          <li><a href="#dwarf"><b>Dwarf:</b></a><span>You are stout but as tough as the mountains.</span></li>
          <li><a href="#elementalkin"><b>Elementalkin:</b></a><span>You have an affinity for the elemental realms, embodying air, earth, fire, ice, or water.</span></li>
          <li><a href="#elf"><b>Elf:</b></a><span>You are nimble and graceful.</span></li>
          <li><a href="#forgeborn"><b>Forgeborn:</b></a><span>You are a sentient construct, animated by magic or ancient craftsmanship.</span></li>
          <li><a href="#goblin"><b>Goblin:</b></a><span>You are small, mischievous, with a knack for survival.</span></li>
          <li><a href="#giantkin"><b>Giantkin:</b></a><span>You possess the power of giants in your blood.</span></li>
          <li><a href="#gnome"><b>Gnome:</b></a><span>You are a shorter people with faerie magic.</span></li>
          <li><a href="#halfling"><b>Halfling:</b></a><span>Smaller humanoids with uncanny luck.</span></li>
          <li><a href="#kobold"><b>Kobold:</b></a><span>You are a small reptilian humanoid that thrives in groups.</span></li>
          <li><a href="#lycanblood"><b>Lycanblood:</b></a><span>You possess the latent powers of a were-creature.</span></li>
          <li><a href="#nephilim"><b>Nephilim:</b></a><span>You have been blessed with celestial powers.</span></li>
          <li><a href="#orc"><b>Orc:</b></a><span>You are fierce and proud.</span></li>
          <li><a href="#silvan"><b>Silvan:</b></a><span>You are a sentient, humanoid plant or tree.</span></li>
          <li><a href="#umbraling"><b>Umbraling:</b></a><span>You have the dark powers of the shadow realm.</span></li>
          <li><a href="#wight"><b>Wight:</b></a><span>You are an undead revenant, kept alive by your anger.</span></li>
          <li><a href="#mixed"><b>Mixed:</b></a><span>Your parents are from two different ancestries, granting you a unique blend of traits.</span></li>
        </ul>
        ...
        <ul>
          ...
          <li><span><b>Animal Characteristics (P):</b> Choose two characteristics from the following list.</span>
            <ul className="beastkin-characteristics">
              ...
              <li><span><b>Natural Weapons:</b> You have claws, sharp teeth, horns, or other means of hurting foes. Your natural melee weapons deal 3 force damage.</span></li>
              <li><span><b>Scales:</b> Your PD increases by +1 while unarmored.</span></li>
        ...
        <ul>
          ...
          <li><span><b>Infernal Heart (S):</b> You gain resistance to unholy damage.</span></li>
        ...
        <ul>
          ...
          <li><span><b>Child of Darkness (S):</b> You gain resistance to necrotic damage.</span></li>
        ...
        <AbilityCard
          ...
          defense="PD"
          damage="5 force damage per your tier"
        ...
        <ul>
          ...
          <li><span><b>Draconic Resistance (S):</b> You gain resistance to the damage type chosen for draconic heritage.</span></li>
        ...
        <ul>
          ...
          <li><span><b>Elemental Affinity (S):</b> You gain resistance to a damage type depending on your elemental soul: lightning (air), fire (fire), or cold (ice). For water, you can breath underwater and gain a swim speed of 1. For earth, your starting hit points increase by your proficiency bonus.</span></li>
        ...
        <ul>
          ...
          <li><span><b>Armored Core (S):</b> Your PD increases by +1.</span></li>
        ...
        <AbilityCard
          ...
          keywords="Magical"
          duration="Scene ends"
          effect="You gain temporary hit points equal to your proficiency bonus, your natural melee weapons deal 3 force damage, and +1 fortune to Disarm, Grab, Shove, Trip, and any skill rolls requiring athleticism."
        />
        ...
        <ul>
          ...
          <li><span><b>Pure of Heart (S):</b> You gain resistance to holy damage.</span></li>
        ...
        <ul>
          ...
          <li><span><b>Undead Resilience (S):</b> You gain resistance to necrotic damage.</span></li>

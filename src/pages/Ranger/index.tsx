    ...
    <div className="ranger">
      <div className="ranger-content">
        ...
        <div className="tab-items">
          <div onClick={toggleDetails} className="tab">Ranger Details</div>
          <div className="divider">|</div>
          <div onClick={toggleSubclasses} className="tab">Ranger Subclasses</div>
          <div className="divider">|</div>
          <div onClick={toggleTalents} className="tab">Ranger Talents</div>
        </div>
        {isDetails && (
          <div>
            <h1>Ranger</h1>
        ...
        {isSubclasses && (
          <div>
            ...
            <h3>Stalker’s Fury (1st-Level Feature)</h3>
            ...
            <h3>Primal Beast (1st-Level Feature)</h3>
            ...
            <h3>Warden Training (1st-Level Feature)</h3>

...
function HeroCreationSteps() {
  ...
  const backgroundInfo = (
    <div>
      <p>
        You create two experiences for your hero at 1st level. As your hero
        progresses, they will automatically gain more experiences. Here are some
        suggestions on the creating your hero's experiences:
      </p>
      <p>
        <b>Backgrounds:</b>{" "}
        <i>
          Bodyguard, Criminal, Historian, Hunter, Inventor, Knight, Mercenary,
          Noble, Pirate, Priest, Scholar, Soldier, Survivalist, Templar, Thief,
          Wizard
        </i>
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          <span>
            <i>Noble</i> vs <i>Exiled Princess from the Iron Kingdom</i>
          </span>
        </li>
        <li>
          <span>
  ...
  return (
    <div className="hero-creation-steps">
      <div className="hcs-content">
        ...
        <h2>Step 3: Choose Experiences</h2>
        <p>
          At 1st level, you choose two <b>experiences</b> for your hero. Your
          experiences represent your hero's background, expertise, and
          personality traits. When your hero makes a{" "}
          <Link className="internal-link" to="/rules/skills">
            skill roll
          </Link>
          , you can invoke a relevant experience to add their proficiency bonus
          to the roll. You can't invoke more than one experience per skill roll.
          For example, a hero with the experience "dragon hunter" could invoke
          this experience to add their proficiency bonus on their skill roll to
          track a monster in the forest.
        </p>
        <Accordion title="Creating Your Experiences" content={backgroundInfo} />
        <button

    ...
    <div className="commander">
      <div className="commander-content">
        ...
        <div className="tab-items">
          <div onClick={toggleDetails} className="tab-items__tab" data-selected={isDetails}>Commander Details</div>
          <div className="tab-items__divider">|</div>
          <div onClick={toggleSubclasses} className="tab-items__tab" data-selected={isSubclasses}>Commander Subclasses</div>
          <div className="tab-items__divider">|</div>
          <div onClick={toggleTalents} className="tab-items__tab" data-selected={isTalents}>Commander Talents</div>
        </div>
        {isDetails && (
          <div>
            <h1>Commander</h1>
        ...
        {isTalents && (
          <div>
            ...
            <p>When you use inspiring attack, the chosen ally can Disengage, Move, Strike, or cast a tier 0 Battle spell as a free action.</p>
            ...
            <p>At the start of a combat encounter, choose an ally to Strike or cast a tier 0 Battle spell as a free action.</p> 

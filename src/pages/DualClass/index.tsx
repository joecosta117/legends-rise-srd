    ...
    <div className="dual-class">
      <div className="dual-class-content">
        ...
        <ul>
          ...
          <li><span><b>Defenses:</b> Determined by your class. Regardless of your classes, your total bonus to Evasion or Might can't be higher than +2.</span></li>

    ...
    <div className="paladin">
      <div className="paladin-content">
        ...
        <div className="tab-items">
          <div onClick={toggleDetails} className="tab">Paladin Details</div>
          <div className="divider">|</div>
          <div onClick={toggleSubclasses} className="tab">Paladin Subclasses</div>
          <div className="divider">|</div>
          <div onClick={toggleTalents} className="tab">Paladin Talents</div>
        </div>
        {isDetails && (
          <div>
            <h1>Paladin</h1>
            ...
            <AbilityCard
              ...
              effect="Expend a recovery for the target to regain hit points equal to your shaken value, and they can make an overcome roll against an effect." 
            />
        ...
        {isSubclasses && (
          <div>
            ...
            <h3>Divine Shield (1st-Level Feature)</h3>
            <p>You gain the following ability:</p>
            <AbilityCard
              name="Divine Shield"
              actType="Reaction"
            ...
            <h3>Oath of Vengeance (1st-Level Feature)</h3>
            <p>You gain the following ability:</p>
            <AbilityCard
            ...
            <h3>Divine Judgement (1st-Level Feature)</h3>
        ...
        {isTalents && (
          <div>
            ...
            <h3>Communal Restoration</h3>
            <p>When you use restorative touch on an ally, you also regain hit points equal to half your shaken value.</p>

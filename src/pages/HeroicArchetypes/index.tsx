      ...
      <div className='archetypes-content'>
        ...
        {selectedArchetype === "Chronomancer" && (
          <div>
            ...
            <p>You learn the chronal adjustment battle spell. At the start of combat before anyone takes a turn, you can cast chronal adjustment as a free action.</p>
        ...
        {selectedArchetype === "Demonologist" && (
          <div>
            ...
            <h4 className="header">Profane Transformation (7th-Level Feature)</h4>
        ...
        {selectedArchetype === "Dual Wielder" && (
          <div>
            ...
            <h4 className="header">Dual Wielder Training (5th-Level Feature)</h4>
            <p>You gain the following:</p>
            <ul>
              <li><span>Training in standard melee weapons, thrown ranged weapons, short ranged weapons, and light armor</span></li>
        ...
        {selectedArchetype === "Geomancer" && (
          <div>
            ...
            <h4 className="header">Strength of the Mountains (7th-Level Feature)</h4>
        ...
        {selectedArchetype === "Hydromancer" && (
          <div>
            ...
            <p>You glide around like on water. When you cast a spell, you can Disengage as a free action.</p>
          </div>
        )}
        {selectedArchetype === "Illusionist" && (
          <div>
            ...
            <p>Your illusions constantly hide you and your allies. When you cast a battle spell of tier 1 or higher, choose a willing creature within 1 zone. The target becomes invisible (turn ends).</p>
          </div>
        )}
        {selectedArchetype === "Jumper" && (
          <div>
            ...
            <p>You are constantly teleporting across the battlefield. When you cast a battle spell of tier 1 or higher, choose a willing creature within your zone to teleport up to 1 zone.</p>
          </div>
        )}
        ...
        {selectedArchetype === "Life Weaver" && (
          <div>
            ...
            <p>When you use a magical ability to heal a creature, the healing amount increases by the spell’s tier or your tier if the ability isn’t a spell. The creature can also make an overcome roll against an effect.</p>
        ...
        {selectedArchetype === "Mage Knight" && (
          <div>
            ...
            <p>After you cast a battle spell of tier 1 or higher, you empower your weapon with magic (turn ends). While charged, your next Strike deals 1 additional damage per the spell tier. The damage type matches the damage type of the triggering spell, or arcane if the spell didn’t deal damage. </p>
          </div>
        )}
        ...
        {selectedArchetype === "Psychic" && (
          <div>
            ...
            <ul>
              <li><span>You can cast spells without speaking</span></li>
        ...
        {selectedArchetype === "Warder" && (
          <div>
            ...
            <p>You can split your magical energy to shield an ally. When you cast a battle spell of tier 1 or higher, choose a creature within 1 zone of you to gain temporary hit points equal to double the spell tier (scene ends).</p>
          </div>
        )}

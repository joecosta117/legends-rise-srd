  ...
  [
    {
      ...
      spell: (
        <AbilityCard 
          ...
          duration="8 hours"
          effect="When you cast the spell, you can designate creatures that the spell ignores. A creature can succeed on a skill roll to either detect the sensors or move without triggering the alarm. The challenge tier matches your tier."
    ...
    },
    {
      ...
      spell: (
        <AbilityCard 
          ...
          effect="You make the target look like another creature of the same size. A creature can see through the illusion with a successful skill roll with the challenge tier matching the spellcaster’s tier."
    ...
    },
    {
      ...
      spell: (
        <AbilityCard 
          ...
          effect="Target’s latch mechanism is magically locked to everyone but you and other creatures you designate. The target can be opened by a skill roll with the challenge tier matching your tier. When the target is opened by anyone not designated by you, the spell ends."
    ...
    },
    {
      ...
      spell: (
        <AbilityCard 
          ...
          keywords="Magical"
          cast="10 minutes"
          effect="Your zone is surrounded by a dome of transparent arcane energy. You and designated creatures can freely move in and out of the dome. Other creatures can’t enter without succeeding on a skill roll with the challenge tier matching the spell tier."

...
const AbilityCard: React.FC<AbilityCardProps> = ({ name, actType, descriptor, frequency, keywords, duration, trigger, target, damage, defense, critical, success, partial, failure, effect, requirement }) => {
  ...
  return (
    <div className="ability" data-type={actType}>
      ...
      <div className="ability__details">
        ...
        {requirement && <p className="ability__line"><b>Requirement:</b> {requirement}</p>}
